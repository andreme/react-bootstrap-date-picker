...
var Calendar = (0, _createReactClass2.default)({
  ...
  render: function render() {
    ...
    var selectedDate = getLocalDate(this.props.selectedDate);
    var minDate = getLocalDate(this.props.minDate);
    var maxDate = getLocalDate(this.props.maxDate);
    ...
    for (var i = 0; i < 9; i++) {
      ...
      for (var j = 0; j <= 6; j++) {
        if (day <= monthLength && (i > 0 || j >= startingDay)) {
          ...
          var beforeMinDate = minDate && date < minDate;
          var afterMinDate = maxDate && date > maxDate;
...
exports.default = (0, _createReactClass2.default)({
  ...
  makeDateValues: function makeDateValues(isoString) {
    ...
    var selectedDate = getLocalDate(isoString);
    var minDate = getLocalDate(this.props.minDate);
    var maxDate = getLocalDate(this.props.maxDate);
  ...
  doBlur: function doBlur() {
    if (this.props.onBlur) {
      ...
      var node = _reactDom2.default.findDOMNode(this.refs.hiddenInput);
